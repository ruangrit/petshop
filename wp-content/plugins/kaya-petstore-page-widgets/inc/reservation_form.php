...
$site_owners_email ='harish.k.532@gmail.com'; 
$error = '';
if ($res_name=="") {
...
if (!$error) {
	...
	$headers .= "Reply-To: ".$res_email."\r\n"
		."X-Mailer: PHP/" . phpversion();
		$mail = mail($site_owners_email, $res_subject, $message,$headers);
	echo "<div class='success'>" . $res_name ; _e("We've received your Reservation Details. We'll be in touch with you as soon as possible!","cooks"); echo "</div>";
