...
<div class="search_post">  
   	<h4 class="blog_post_title">
   		<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'petstore' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">   <?php the_title(); ?> </a>
   	</h4>
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        <?php echo the_excerpt(); ?>           
		<?php echo '<a href="'.get_permalink().'" class="readmore">'.$kaya_readmore_blog.'</a>'; ?>
    </div>
</div>
