...
if(!empty($sidebars)){
$Woocommerce_custom_sidebar = get_theme_mod('Woocommerce_custom_sidebar') ? get_theme_mod('Woocommerce_custom_sidebar') : 'sidebar-1';
}else{
	$Woocommerce_custom_sidebar  = 'sidebar-1';
}
//$Woocommerce_custom_sidebar = get_theme_mod('Woocommerce_custom_sidebar') ? get_theme_mod('Woocommerce_custom_sidebar') : 'sidebar';
				...
				<?php }
					...
					if( $woo_cat_product_sidebar != 'fullwidth' ) { ?>	
						<aside class="<?php echo $woo_cat_product_sidebar_position.'  '.$product_sidebar_border_class; ?>"> <!--Start Sidebar Section -->
							<?php	 dynamic_sidebar($Woocommerce_custom_sidebar); ?>
						</aside> <!--End Sidebar Section -->
				<?php }
				}elseif( is_singular('product') ) {
